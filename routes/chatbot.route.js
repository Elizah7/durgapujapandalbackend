...
chatbotRoute.get('/query', async (req, res) => {
    ...
    for (let i = 0; i < totaluser.length; i++) {
        ...
        console.log(nameEntityName, nameVariations);
    ...
    function getVariations(name) {
        ...
        // You can add more variations or use different techniques to generate variations here
